...
const int sensorAddresses[numberOfSensors] = {ADDR_TEMP_WEST, ADDR_TEMP_WEST, ADDR_TEMP_EAST, ADDR_TEMP_WEST, ADDR_TEMP_WEST, ADDR_TEMP_WEST, ADDR_TEMP_WEST, ADDR_TEMP_WEST, ADDR_TEMP_WEST};
...
int sensorReadings[numberOfSensors] = {0, 0, 0, 0, 301, 0, 0, 0, 40};
