...
const int sensorAddresses[numberOfSensors] = {ADDR_TEMP_WEST, ADDR_TEMP_WEST, ADDR_TEMP_EAST, ADDR_TEMP_WEST, ADDR_TEMP_WEST, ADDR_TEMP_WEST, ADDR_PRES_WEST, ADDR_PRES_EAST, ADDR_PRES_SYST};
